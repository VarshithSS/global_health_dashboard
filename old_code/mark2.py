...
app.title = "NCD Care Observatory · CS661 Group 5"
server = app.server
...
<head>
    ...
    <style>
      ...
      * { box-sizing:border-box; }
      ...
      /* Dark dropdowns (react-select v1 classes used by dcc.Dropdown) */
      ...
      .Select.is-focused:not(.is-open) > .Select-control {
        border-color:var(--accent) !important; box-shadow:0 0 0 1px rgba(45,212,191,0.6) !important;
      }
      .Select-menu-outer {
        background:var(--panel2) !important; border-color:var(--border) !important;
        border-radius:9px !important; z-index:40 !important;
      }
      .Select-value-label, .Select-input > input, .Select--single > .Select-control .Select-value .Select-value-label {
        color:var(--text) !important;
      }
      .Select-placeholder { color:var(--muted) !important; }
      .Select-option { background:var(--panel2) !important; color:var(--text2) !important; }
      .Select-option.is-focused { background:var(--elev) !important; color:var(--text) !important; }
      .Select-option.is-selected { background:rgba(45,212,191,0.14) !important; color:var(--text) !important; }
      .Select-arrow { border-color:var(--muted) transparent transparent !important; }
      .Select--multi .Select-value {
        background:rgba(45,212,191,0.14) !important; border:1px solid rgba(45,212,191,0.4) !important;
        color:var(--text) !important; border-radius:6px !important;
      }
      .Select--multi .Select-value-icon { border-right-color:rgba(45,212,191,0.4) !important; }
      .Select--multi .Select-value-icon:hover { background:rgba(45,212,191,0.25) !important; color:var(--text) !important; }

      /* Sliders (rc-slider) */
      .rc-slider-rail { background:var(--border) !important; }
      .rc-slider-track { background:linear-gradient(90deg,var(--accent2),var(--accent)) !important; }
      .rc-slider-handle {
        border-color:var(--accent) !important; background:var(--panel) !important; opacity:1 !important;
      }
      ...
      .rc-slider-mark-text-active { color:var(--text2) !important; }
      .rc-slider-dot { border-color:var(--border) !important; background:var(--panel2) !important; }
      .rc-slider-dot-active { border-color:var(--accent) !important; }
      .rc-slider-tooltip-inner { background:var(--accent) !important; color:#04211d !important; font-weight:700; }
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            ...
            "module) · six NCD indicators, ~71k rows · Mark 2 UI · "
            "CS661 Group 5",
...
if __name__ == "__main__":
    print("=" * 70)
    print("NCD Care Inequality Observatory — MARK 2 UI")
    print("=" * 70)
