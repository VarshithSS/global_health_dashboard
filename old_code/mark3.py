...
app.title = "NCD Care Observatory · CS661 Group 5 · Mark 3"
server = app.server
...
<head>
    ...
    <style>
      ...
      * { box-sizing:border-box; }
      ...
      /* Value tooltip: teal pill, dark text, sitting above the slider. */
      .dash-slider-tooltip .hover-content, .dash-slider-tooltip {
        color: #04211d !important; font-weight: 700 !important;
      }
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            ...
            "module) · six NCD indicators, ~71k rows · Mark 3 UI · "
            "CS661 Group 5",
...
if __name__ == "__main__":
    print("=" * 70)
    print("NCD Care Inequality Observatory — MARK 3 UI")
    print("=" * 70)
